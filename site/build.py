...
<section class="hero" style="padding-bottom:24px">
  <div class="wrap" style="grid-template-columns:1fr">
    ...
    <p class="lead">Questions about an order, an application, or the platform: email us and a person answers.</p>
    <div class="btns"><a class="btn primary" href="mailto:team@firstlineperform.com">team@firstlineperform.com</a></div>
    </div>
  </div>
</section>
<section class="tight">
  <div class="wrap">
    <div class="grid cols3">
      <div class="card"><h3>Parents</h3><p class="muted">Order questions are fastest from the order page in your account, where FLP can see the job. For anything else, email.</p></div>
      <div class="card"><h3>Mentors</h3><p class="muted">Application status, payouts and profile questions: email with the address you applied with.</p></div>
      <div class="card"><h3>Safety</h3><p class="muted">Anything concerning a minor's safety: email with "Safeguarding" in the subject and it goes to the top of the queue.</p></div>
    </div>
